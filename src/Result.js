...
function Result() {
  ...
  const [image, setImage] = useState("results.png")
  ...
  async function precision(){
    ...
    const percentage = (tempHelpfulAnswers / questionsDone.length) * 100
  ...
  useEffect(() => {
    ...
    const animate = (timestamp) => {
      ...
      setAnimatedValue((eased * message).toFixed(2))
  ...
  return(
    ...
    >
      <Box component="img" src="satoshi_title.png" sx={{ height: "30%", position: "absolute", top: 0, left: 0 }}/>
            ...
            <Container sx={{ display: "flex", flexDirection: "column" }}>
              ...
              <Typography
                ...
                sx={{
                  ...
                  fontSize: 17,
                  top: "54%",
                  right: (questionsDone.length >= 10 ) ? "24%": "25%",
